...
describe('CheerListData', function () {
  ...
  describe('addCheerDataList test', function () {
    it('Should add CheerDataLists', async () => {
      ...
      getMyProjectCheerList = await cheerListData.getMyProjectCheerList(project1.address);
      expect(getMyProjectCheerList).to.deep.equal([]);
      ...
      getMyProjectCheerList = await cheerListData.getMyProjectCheerList(userPool1.address);
      expect(getMyProjectCheerList[0][0]).to.equal(project1.address);
      expect(getMyProjectCheerList[0][1]).to.equal(userPool1.address);
      expect(getMyProjectCheerList[0][2]).to.equal(123);
      expect(getMyProjectCheerList[0][3]).to.equal("ガンバ！");
      expect(getMyProjectCheerList[0][4]).to.equal(100);
